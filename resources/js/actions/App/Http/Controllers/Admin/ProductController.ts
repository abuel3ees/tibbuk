...
* @see app/Http/Controllers/Admin/ProductController.php:48
...
* @see app/Http/Controllers/Admin/ProductController.php:119
...
* @see app/Http/Controllers/Admin/ProductController.php:107
* @route '/admin/products/{product}'
*/
...
const ProductController = { index, create, store, importMethod, edit, update, destroy, import: importMethod }
